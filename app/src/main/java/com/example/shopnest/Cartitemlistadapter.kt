...
import kotlinx.android.synthetic.main.activity_cartlayout.view.*
            ...
            holder.itemView.ib_remove_cart_item.setOnClickListener {
                ...
                if (model.cart_quantity == "1") {
                    ...
                    if (context is Cartlistactivity) {
                        context.showprogressdialog(context.resources.getString(R.string.pleasewait))
                    }
