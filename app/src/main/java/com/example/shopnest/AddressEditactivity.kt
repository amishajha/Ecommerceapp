...
import kotlinx.android.synthetic.main.activity_address_editactivity.*

class AddressEditactivity :baseactivityt() {
   private var mAddressDetails: Address? = null
    override fun onCreate(savedInstanceState: Bundle?) {

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_address_editactivity)
        ...
        if (validateData()) {
          ...
          showprogressdialog(resources.getString(R.string.pleasewait))
            ...
            if (mAddressDetails != null && mAddressDetails!!.id.isNotEmpty()) {
                ...
                Firestoreclass().addAddress(this@AddressEditactivity, addressModel)
            }
            // END
        }
    }
