...
import kotlinx.android.synthetic.main.addproductactivity.*
import java.io.IOException

class Addproductactivity : baseactivityt(), View.OnClickListener {
    ...
    private fun uploadProductDetails() {
        ...
        val username =
                this.getSharedPreferences(Constants.SHOPNEST_PREFERENCES, Context.MODE_PRIVATE)
